...
?>
	<div class="wrapper">
		<div class="about">
				<div class="container">
					...
					<div class="about-text">
						<h3 class="about-title">A proposito di me</h3>
						<div class="about-text-p">
							<p>L’avvocato Davide è uno dei pochi avvocati ufficiali autorizzati in Italia bilingue Italiano e Russo. È specializzato in contenzioso e risoluzione alternativa delle controversie, immigrazione, diritto societario e fiscale, questioni immobiliari e diritto di famiglia.</p>
							<p>Molti clienti e associazioni di lingua russa in Italia si affidano ai suoi consigli, alla sua professionalità e lealtà.
	                        </p>
						</div>
						<p class="btn-about">Più dettagli</p>
					</div>
				</div>
		</div>
		<div class="story">
		...
		<div class="gallary">
			<div class="container">
				<h3 class="gallary-title">Galleria</h3>
				<div class="gallary-container">
					<div class="gallary-column">
						<img src="<?= get_template_directory_uri() . "/assets/img/" ?>gallary/1.png" alt="">
						<img src="<?= get_template_directory_uri() . "/assets/img/" ?>gallary/2.png" alt="">
					</div>
					<div class="gallary-columns">
					    <img  src="<?= get_template_directory_uri() . "/assets/img/" ?>gallary/3.png" alt="">
					    <img  src="<?= get_template_directory_uri() . "/assets/img/" ?>gallary/4.png" alt="">
					</div>
				</div>
				<div class="btn-gallary">Vai alla galleria</div>
			</div>
		</div>
		<div class="blog">
			<div class="container">
				...
				<div class="blog-container">
					<div class="blog-item">
						<img src="<?= get_template_directory_uri() . "/assets/img/" ?>blog/1.png" alt="" class="blog-img">
						<h5 class="blog-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h5>
						<p class="blog-date">05.10.2021</p>
						<p class="blog-text">Etiam vestibulum convallis tellus in porttitor. Sed aliquam mi ut cursus faucibus. Curabitur gravida, eros nec tristique pellentesque, enim nunc ullamcorper mi, et malesuada magna justo in nibh....</p>
						<p class="btn-full">Per saperne di più</p>
					</div>
					<div class="blog-item">
						<img src="<?= get_template_directory_uri() . "/assets/img/" ?>blog/2.png" alt="" class="blog-img">
						<h5 class="blog-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h5>
						<p class="blog-date">05.10.2021</p>
						<p class="blog-text">Etiam vestibulum convallis tellus in porttitor. Sed aliquam mi ut cursus faucibus. Curabitur gravida, eros nec tristique pellentesque, enim nunc ullamcorper mi, et malesuada magna justo in nibh....</p>
						<p class="btn-full">Per saperne di più</p>
					...
					<div class="blog-item">
						<img src="<?= get_template_directory_uri() . "/assets/img/" ?>blog/3.png" alt="" class="blog-img">
						<h5 class="blog-subtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h5>
						<p class="blog-date">05.10.2021</p>
						<p class="blog-text">Etiam vestibulum convallis tellus in porttitor. Sed aliquam mi ut cursus faucibus. Curabitur gravida, eros nec tristique pellentesque, enim nunc ullamcorper mi, et malesuada magna justo in nibh....</p>
						<p class="btn-full">Per saperne di più</p>
